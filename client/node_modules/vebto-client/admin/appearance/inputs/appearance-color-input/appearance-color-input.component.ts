...
import {ColorPickerPanel} from "../../../../core/ui/color-picker/color-picker-panel.service";
...
export class AppearanceColorInputComponent implements OnInit {
    ...
    public openColorPicker(e: MouseEvent) {
        this.colorPicker.open(new ElementRef(e.target), {position: 'bottom'}).selected.subscribe(color => {
