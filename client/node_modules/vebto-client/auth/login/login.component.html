<form class="auth-page" id="auth-page" (ngSubmit)="login()" ngNativeValidate>
    <div class="many-inputs auth-panel">
        ...
        <div class="input-container">
            ...
            <input type="password" id="password" [(ngModel)]="model.password" name="password" id="password" required placeholder="Password">
        ...
        <ng-container *ngIf="!settings.get('registration.disable')">
            ...
            <div class="social-icons center">
                ...
                <button type="button" (click)="socialAuth.loginWith('google')" *ngIf="settings.get('social.google.enable')" class="social-icon no-style google" tooltip="Login with google">
