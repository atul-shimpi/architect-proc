...
type MenuParams = {data?: object, overlay?: Overlay, offsetX?: number, offsetY?: number};
...
export class ContextMenu {
     ...
     */
    public open<T>(component: Type<T>, e: MouseEvent, params: MenuParams): ComponentRef<T> {
        this.bindToEvents();
    ...
    private createOverlay(e: MouseEvent, params: MenuParams) {
    ...
    private getMenuPositionStrategy(e: MouseEvent, params: MenuParams): PositionStrategy {
